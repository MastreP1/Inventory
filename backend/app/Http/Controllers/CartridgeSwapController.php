...
/**
 * CartridgeSwapController — previously "CartridgeSwapController",
 * now handles "Cartridge Changes" (renamed in UI, same backend endpoint).
 */
class CartridgeSwapController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['message' => 'Cartridge change record deleted.']);
    }
