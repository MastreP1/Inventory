...
class DeviceLogService
{
     ...
     *
     * @param int        $deviceId  The device this event is about (always required)
     * @param string     $action    One of the documented action strings (see DeviceLog migration)
     * @param array|null $details   Plain PHP array — Eloquent cast handles JSON encoding.
     *                              NEVER json_encode() before passing.
     *
     * Supported actions:
     *   Device lifecycle:  status_changed
     *   User assignments:  assigned, unassigned
     *   Movements:         moved
     *   Location swaps:    location_swapped
     *   Owner swaps:       owner_swapped
     *   Drive ops:         drive_assigned, drive_unassigned, drive_swapped
     *   Cartridge ops:     cartridge_assigned, cartridge_unassigned, cartridge_swapped
     */
